      ...
      <div class="login-right-wp">
        ...
        <div class="login-pwd-wp">
          <el-form label-width="auto" label-position="right">
            ...
            <!--这里必须用箭头函数,因为方法返回的是Promise,直接写会出现奇怪问题-->
            <el-button class="login" color="#00aeec" style="color: #fff" @click="() => userStore.login()">
              登录
            </el-button>
          </el-form>
        </div>
          ...
          <div class="header-entry-large">
            ...
            <div class="vip-item">
              <a class="vip-item__label">
                <img src="https://i1.hdslb.com/bfs/vip/8d4f8bfc713826a5412a0a27eaaac4d6b9ede1d9.png@800w_40h_0e"
                  alt="" />
              </a>
            ...
            <div class="counts-item">
              <a href="#" class="single-count-item">
                <span class="counts-item__num">9999</span><span class="counts-item__text">关注</span>
              </a>
              <a href="#" class="single-count-item">
                <span class="counts-item__num">9999</span><span class="counts-item__text">粉丝</span>
              </a>
              <a href="#" class="single-count-item">
