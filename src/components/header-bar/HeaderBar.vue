...
// 收起状态下的最大高度（2 行），与 CSS 中 max-height 保持一致
const COLLAPSED_MAX_HEIGHT = 62
...
const checkHistoryOverflow = () => {
  nextTick(() => {
    ...
    // scrollHeight 反映完整内容高度，不受 max-height 裁切影响
